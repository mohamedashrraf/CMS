...
export class CreateRoleComponent {
  ...
  /** OUTPUT */
  @Output() toggleCreateRole = new EventEmitter<Boolean>();
  @Output() addRoleForm = new EventEmitter<NewRole>();
  ...
  newRole() {
    ...
    this.addRoleForm.emit(this.addRole.value);
  }
  ...
  close() {
    this.toggleCreateRole.emit(false);
  }
